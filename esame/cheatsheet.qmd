...
if i > j then
 ...
 -
```
- $\forall ~ searchFirst(A,v,i,j), \forall h \in A[1...i-1], h < v ~ \myand  ~ \forall k \in A[i...j], k \geq v$

Con questo algoritmo troviamo la **prima** (più a sinistra) occorrenza di v.
...
if i > j then
 ...
 -
```
- $\forall ~ searchLast(A,v,i,j), \forall h \in A[j+1...n], h > v ~ \myand  ~ \forall k \in A[i...j], k \geq v$
